...
<html>
    ...
    <body style="padding: 20px">
        ...
        <form class="pure-form" 
            ...
            <fieldset>
                <legend>BMI(session)使用人數:${ applicationScope.count }人</legend>
                <input name="cname" type="text" placeholder="姓名" value="Yun"><p /> 
                ...
                <img src="/JavaWeb20210531/controller/authcode" valign="middle"/>
                <p />
                <button type="submit" class="pure-button pure-button-primary">傳送</button>
                <button type="button" onclick="location.href = '/JavaWeb20210531/controller/bmi_session'" 
                        class="pure-button pure-button-primary">檢視</button>
                <button type="button" onclick="location.href = '/JavaWeb20210531/controller/bmi_session_invalid'" 
